...
def main() -> None:
    ...
    application.add_handler(CallbackQueryHandler(handler.handle_model_selection, pattern="^model_(gpt|llama)$"))
    application.add_handler(CallbackQueryHandler(handler.handle_genre_selection, pattern="^genre_"))
